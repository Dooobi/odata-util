sap.ui.define([
	...
	"fis/tgh/odatautils/model/Constant",
	"fis/tgh/odatautils/model/formatter",
	"fis/tgh/odatautils/helper/util",
	"fis/tgh/odatautils/helper/metadataTransformer",
	"sap/ui/model/json/JSONModel",
	"sap/ui/layout/SplitterLayoutData",
	"fis/tgh/odatautils/controller/BatchRequestDialogController",
	...
	return BaseController.extend("fis.tgh.odatautils.controller.Main", {
		...
		requestListItemFactory: function(id, context) {
			switch (context.getProperty("type")) {
				...
				case Constant.REQUEST_REMOVE:
					var fragment = sap.ui.xmlfragment("fis.tgh.odatautils.view.fragment.CrudRequestListItem", this),
				...
				case Constant.REQUEST_FUNCTION_IMPORT:
					return sap.ui.xmlfragment("fis.tgh.odatautils.view.fragment.FunctionImportRequestListItem", this);
			}
		},
		...
		pressHistory: function(event) {
			...
			var popover = sap.ui.xmlfragment("popover", "fis.tgh.odatautils.view.fragment.Popover", this);
