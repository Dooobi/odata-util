sap.ui.define([
	...
	"fis/tgh/odatautils/controller/BatchAttachDialogController"
], function(BaseController, util, JSONModel, FormElement, Label, Icon, HBox, FlexRendertype, BatchAttachDialogController) {
	"use strict";

	var FRAGMENT_NAME = "fis.tgh.odatautils.view.fragment.DeleteDialog";
	
	return BaseController.extend("fis.tgh.odatautils.controller.DeleteDialogController", {
